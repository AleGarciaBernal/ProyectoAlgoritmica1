...
void ejemploAri2() {
    ...
    if(cambio != 0){
        ...
        case 12:
            ...
            break;
        case 13:
            cout << "Existen " << coinChange(cambio) << " maneras de dar el cambio, y son las siguientes posibilidades:" << endl;
            printChanges(length(coins), cambio);
            break;
        default:
            cout<<"No existe esa opcion"<<endl;
...
void ejemploAle2() {
    ...
    if(cambio != 0){
        ...
        case 11:
            ...
            break;
        case 12:
            cout << "La mínima cantidad de monedas y/o billetes usados para dar el cambio es " << coinChangeMin(cambio) << "." << endl;
            break;
        case 13:
            cout << "Existen " << coinChange(cambio) << " maneras de dar el cambio, y son las siguientes posibilidades:" << endl;
            printChanges(length(coins), cambio);
